...
class MyHostels extends StatefulWidget {
  const MyHostels({super.key});

  @override
  State<MyHostels> createState() => _MyHostelsState();
}

class _MyHostelsState extends State<MyHostels> {
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                          image: NetworkImage(hostel['imageUrl']),
                                          fit: BoxFit.fill,
                                        ),
                                      ),
                                    ),
